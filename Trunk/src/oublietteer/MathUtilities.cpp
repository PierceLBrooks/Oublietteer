...
const float oublietteer::util::HALF_PI = PI*0.5f;

const float oublietteer::util::QUARTER_PI = HALF_PI*0.5f;

const float oublietteer::util::TWO_PI = PI*2.0f;

const float oublietteer::util::RAD_TO_DEG = 180.0f/PI;

const float oublietteer::util::DEG_TO_RAD = PI/180.0f;
